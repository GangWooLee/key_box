...
ActiveRecord::Schema[8.1].define(version: 2026_03_02_010001) do
  ...
  create_table "vault_configs", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.binary "encrypted_master_key", null: false
    t.binary "master_key_salt", null: false
    t.string "master_password_digest", null: false
    t.datetime "updated_at", null: false
    t.integer "vault_id", null: false
    t.index ["vault_id"], name: "index_vault_configs_on_vault_id", unique: true
  end
  ...
  add_foreign_key "vault_configs", "vaults"
end
