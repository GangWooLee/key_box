...
class SecretDao extends DatabaseAccessor<AppDatabase> with _$SecretDaoMixin {
  ...
  Future<bool> updateSecret(
    ...
    return (update(secrets)..where((t) => t.id.equals(id))).write(
      SecretsCompanion(
        ...
        encryptedValueAuthTag: encryptedValueAuthTag != null
            ...
            : const Value.absent(),
        secretType: secretType != null ? Value(secretType) : const Value.absent(),
        serviceName: serviceName != null ? Value(serviceName) : const Value.absent(),
        environment: environment != null ? Value(environment) : const Value.absent(),
